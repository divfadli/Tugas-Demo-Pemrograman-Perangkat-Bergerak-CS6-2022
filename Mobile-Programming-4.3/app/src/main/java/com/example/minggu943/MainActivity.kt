...
class MainActivity : AppCompatActivity() {
    ...
    private fun showPicker() {
        val pickerOptions = arrayOf("Jakarta", "Bandung", "Surabaya", "Bogor")

        val builder = androidx.appcompat.app.AlertDialog.Builder(this)
        builder.setTitle(getString(R.string.buttons_city) + ":")

        builder.setItems(pickerOptions) { _, which ->
            tvSelectedOption.text = getString(R.string.city_name) + " ${pickerOptions[which]}"
